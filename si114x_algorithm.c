...
static gesture_t ProcessSi1147PosSamples(Si114x_Sample_TypeDef *samples, 
                                          int *dist);
...
gesture_t Si1147_NewPosSample(I2C_TypeDef *i2c, uint8_t addr, uint32_t timestamp, 
                              int *dist)
{
  ...
  /*look for gestures */
  return ProcessSi1147PosSamples(&sample, dist);
}
