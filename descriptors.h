...
extern const HIDKBD_MouseReport_t            USBDESC_noMouseReport;
extern const HIDKBD_MouseReport_t            USBDESC_leftMouseReport;
extern const HIDKBD_MouseReport_t            USBDESC_rightMouseReport;
